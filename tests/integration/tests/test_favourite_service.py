...
class TestFavouriteServiceComplete:
    ...
    def create_test_favourite(self):
        ...
        assert is_success_status(response.status_code), f"Error al crear favorito: {response.text}"
    ...
    def test_favourite_with_different_users_same_product(self):
        ...
        assert is_success_status(response_1.status_code)
        ...
        assert is_success_status(response_2.status_code)
