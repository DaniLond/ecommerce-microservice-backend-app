...
class TestUserServiceE2E:
    ...
    def test_e2e_user_with_address_management(self, cleanup_resources):
        ...
        assert is_success_status(user_response.status_code)
        ...
        assert is_success_status(address_response.status_code)
        ...
        assert is_success_status(update_address_response.status_code)
        ...
        assert is_success_status(all_addresses_response.status_code)
    ...
    def test_e2e_user_credentials_workflow(self, cleanup_resources):
        ...
        assert is_success_status(credential_response.status_code)
        ...
        assert is_success_status(username_response.status_code)
        ...
        assert is_success_status(update_credential_response.status_code)
    ...
    def test_e2e_verification_token_workflow(self, cleanup_resources):
        ...
        assert is_success_status(token_response.status_code)
        ...
        assert is_success_status(get_token_response.status_code)
        ...
        assert is_success_status(update_token_response.status_code)
    ...
    def test_e2e_multiple_users_listing(self, cleanup_resources):
        ...
        assert is_success_status(all_users_response.status_code)
        ...
        for created_user in created_users:
            ...
            assert is_success_status(specific_user_response.status_code)
        ...
        assert is_success_status(known_user_response.status_code)
