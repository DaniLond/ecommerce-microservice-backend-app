...
class TestShippingServiceE2E:
    ...
    @pytest.mark.skip(reason="Faltan datos de órdenes necesarias en la base de datos")
    ...
    def test_e2e_multiple_products_single_order_shipping(self, cleanup_resources):
        ...
        assert is_success_status(update_response_1.status_code)
        ...
        assert is_success_status(update_response_2.status_code)
    ...
    def test_e2e_shipping_quantity_management_workflow(self, cleanup_resources):
        ...
        assert is_success_status(shipping_response.status_code)
        ...
        assert is_success_status(picking_response.status_code)
        ...
        assert is_success_status(inventory_response.status_code)
