...
class TestProductServiceE2E:
    ...
    @pytest.mark.skip(reason="Backend devuelve 500 Internal Server Error al crear categorías")
    def test_e2e_complete_category_lifecycle(self, cleanup_resources):
        ...
        assert is_success_status(all_categories_response.status_code)
    ...
    def test_e2e_product_with_category_workflow(self, cleanup_resources):
        ...
        assert is_success_status(category_response.status_code)
        ...
        assert is_success_status(product_response.status_code)
        ...
        assert is_success_status(get_product_response.status_code)
        ...
        assert is_success_status(update_product_response.status_code)
    ...
    def test_e2e_multiple_products_in_category(self, cleanup_resources):
        ...
        assert is_success_status(all_products_response.status_code)
        ...
        for created_product in created_products:
            ...
            assert is_success_status(specific_product_response.status_code)
    ...
    def test_e2e_product_inventory_management(self, cleanup_resources):
        ...
        assert is_success_status(update_inventory_response.status_code)
        ...
        assert is_success_status(price_update_response.status_code)
        ...
        assert is_success_status(restock_response.status_code)
