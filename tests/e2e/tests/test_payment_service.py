...
class TestPaymentServiceE2E:
    ...
    def test_e2e_payment_status_transitions(self, cleanup_resources):
        ...
        assert is_success_status(payment_response.status_code)
        ...
        assert is_success_status(progress_response.status_code)
        ...
        assert is_success_status(completed_response.status_code)
        ...
        assert is_success_status(final_check_response.status_code)
    ...
    def test_e2e_multiple_payments_for_orders(self, cleanup_resources):
        ...
        assert is_success_status(all_payments_response.status_code)
        ...
        for created_payment in created_payments:
            ...
            assert is_success_status(specific_payment_response.status_code)
    ...
    def test_e2e_payment_failure_and_retry(self, cleanup_resources):
        ...
        assert is_success_status(retry_response.status_code)
        ...
        assert is_success_status(second_attempt_response.status_code)
        ...
        assert is_success_status(success_response.status_code)
    ...
    def test_e2e_payment_bulk_processing(self, cleanup_resources):
        ...
        assert is_success_status(final_payments_response.status_code)
